from PySide6.QtWidgets import (QWidget, QHBoxLayout, QVBoxLayout, QPushButton,
                             QSlider, QLabel, QFrame, QSizePolicy, QComboBox)
...
class EnhancedControlBar(QWidget):
    ...
    def setup_ui(self):
        ...
        self.metadata_summary_label.setStyleSheet("color: rgba(255, 255, 255, 150); font-size: 10px;")
    ...
    def setup_styling(self):
        ...
        self.setStyleSheet("""
            ...
            QComboBox QAbstractItemView {
                ...
                border: 1px solid rgba(100, 100, 100, 100);
                color: white;
                selection-background-color: rgba(100, 149, 237, 180);
            }
            ...
            QSlider::handle:horizontal {
                ...
                border: 1px solid rgba(100, 149, 237, 255);
                width: 16px;
                height: 16px;
                margin: -6px 0;
                border-radius: 8px;
            ...
            QSlider::handle:horizontal:hover {
                ...
                border-color: rgba(135, 206, 250, 255);
            }
    ...
    def setup_animations(self):
        ...
        self.fade_animation = QPropertyAnimation(self, b"control_opacity")
        self.fade_animation.setDuration(300)
        self.fade_animation.setEasingCurve(QEasingCurve.OutCubic)
        
    @Property(float)
    def control_opacity(self):
        return self._control_opacity
        
    @control_opacity.setter
    def control_opacity(self, value):
    ...
    def fade_in(self):
        ...
        self.fade_animation.setStartValue(self._control_opacity)
