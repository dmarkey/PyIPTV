<div align="center">
  <img src="pyptv/ui/images/logo.png" alt="PyPTV Logo" width="200"/>
  ...
  **A Modern Python IPTV Player**
  ...
  [![Maintenance](https://img.shields.io/badge/Maintained%3F-yes-green.svg)](https://github.com/dmarkey/Pyptv/graphs/commit-activity)
...
Launch PyPTV without arguments to open the playlist manager:
...
```bash
pyptv /path/to/your/playlist.m3u
```
...
| `pyptv <playlist_path>` | Launch directly with specified playlist |
...
PyPTV automatically creates configuration files in platform-appropriate locations:

| Platform | Configuration Path |
|----------|-------------------|
| **Linux** | `~/.config/PyPTV/pyptv_settings.json` |
| **Windows** | `%APPDATA%/PyPTV/pyptv_settings.json` |
| **macOS** | `~/.config/PyPTV/pyptv_settings.json` |
...
PyPTV supports standard M3U playlist format with extended information:
...
PyPTV follows a modular architecture design:
...
```bash
PYTHONPATH=. python -m pyptv.main --debug
```
...
- Most of the codebase for PyPTV was generated by Claude Sonnet 4
...
- **Issues**: [GitHub Issues](https://github.com/dmarkey/Pyptv/issues)
- **Discussions**: [GitHub Discussions](https://github.com/dmarkey/Pyptv/discussions)
